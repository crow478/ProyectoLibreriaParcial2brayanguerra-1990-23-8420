...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/cuenta (2).png"))); // NOI18N
    ...
    String Dpi = new String(jPasswordField1.getPassword());  // Dpi como contraseña
    
    // Verificar si los campos están vacíos
    if (usuario.equals("") || Dpi.equals("")) {
        JOptionPane.showMessageDialog(this, "Debe Ingresar sus datos");
        jTextField1.requestFocus();
    } else {
        // Validar las credenciales con la base de datos
        ev = vdao.ValidarVendedor(Dpi, usuario);
        
        // Verificar si el vendedor existe
        if (ev != null && ev.getusuario() != null && ev.getDpi() != null) {
            Principal p = new Principal();  // Cambia esto a tu pantalla principal
            p.setVisible(true);
            dispose();
        } else {
